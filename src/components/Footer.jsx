    ...
    <footer className="bg-gradient-to-b from-gray-50 to-white border-t border-gray-100 py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            ...
            <p className="text-gray-600 text-sm">
              Votre partenaire digital pour une présence web moderne et performante.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/services" className="text-gray-600 hover:text-primary text-sm transition-colors">
                  Services
                </Link>
              </li>
              <li>
                <Link to="/portfolio" className="text-gray-600 hover:text-primary text-sm transition-colors">
                  Portfolio
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <p className="text-gray-600 text-sm mb-2">
              <a href="mailto:contact@neodigital.ma" className="hover:text-primary transition-colors">
        ...
        <div className="border-t border-gray-200 pt-8 text-center text-gray-600 text-sm">
          <p>&copy; {new Date().getFullYear()} NeoDigital. Tous droits réservés.</p>
        </div>
      </div>
    </footer>
  );
